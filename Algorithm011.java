    ...
    public void Think() {
        ...
        if (IsEnemyLastMove()) {
            ...
            for (int x = 0; x < Board.BOARD_SIZE; x++) {
                for (int y = 0; y < Board.BOARD_SIZE; y++) {
                    ...
                    Point newPoint = oldPoint.Plus(EnemyLastMoveVector());
                    if (Board.GetCell(oldPoint).GetValue(alphaSide, 0) == -1 && newPoint.IsRange()) {
        ...
        if (IsEnemyLastAttack()) {
            ...
            if (EnemyLastAttackResult().contains(Board.RESULT_HIT)) {
                ...
                // EnemyLastAttackPoint(),
                // Board.GetCrossPoints(EnemyLastAttackPoint(), 1, 2));
